...
const start = $("#start");
const ratios = [
  0, 27.75, 55.5, 83.25, 111, 138.75, 166.5, 194.25, 222, 249.75, 277.5, 305.25,
  332.25,
];
...
function toggleMute() {
  ...
  mute.textContent === "Mute" ? bgPlay.play() : bgPlay.pause();
}
  ...
  if (areSame) {
    ...
    setTimeout(() => {
      ...
      Swal.fire({
        ...
        renderPizza({
          el: pizzaTarget,
          from: currentExercise.args[0],
          to: currentExercise.args[1],
          neg: isNegIdx,
        });
      });
    }, 1500);
